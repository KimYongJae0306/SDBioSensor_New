...
namespace COG
{
    public partial class Form_Main : Form
    {
        ...
        public Form_Main()
        {
            ...
            CpuInfoPanel.Controls.Add(_mUI_Info);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (!Main.DEFINE.OPEN_F && !Main.DEFINE.OPEN_CAM)
            {
                ...
                try
                {
                    Main.OpenDM(Main.DEFINE.ReadLocalPort, Main.DEFINE.ReadRemotePort, Main.DEFINE.RemoteIP, 5000, Main.DEFINE.WriteLocalPort, Main.DEFINE.WriteRemotePort);
                    Main.WriteDevice(PLCDataTag.BASE_RW_ADDR + Main.DEFINE.CURRENT_MODEL_CODE, Convert.ToInt32(Main.ProjectName.Substring(2, 1)));
                 
                }
                catch (System.Exception ex)
                {
                    MessageBox.Show("PLC OPEN ERROR" + ex.Source + ex.Message + ex.StackTrace);
                }
            ...
            //shkang_s 
            //프로그램 재부팅시 오퍼레이터권한으로 초기화
            BTN_PERMISSION.Text = "PERMISSON\r\nOPERATOR";
            Main.machine.Permission = Main.ePermission.OPERATOR;
            //shkang_e
        }
        ...
        private void Allocate_Array()
        {
            ...
            if (Main.DEFINE.PROGRAM_TYPE == "ATT_AREA_PC1" || Main.DEFINE.PROGRAM_TYPE == "QD_LPA_PC2")
            {
                ...
                //LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM1);
                //LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM2);
                //LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM1);
                //LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM2);

                //LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM1);
                //LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM2);
                //LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM1);
                //LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM2);

                //LIST_PB_LIGHT_CONSTAT.Add(PB_CONSTAT_LIGHT1);

                //LIST_PB_LIGHT_DISCONSTAT.Add(PB_DISCONSTAT_LIGHT1);

                //if (Main.DEFINE.PROGRAM_TYPE == "QD_LPA_PC1")
                //{
                //    LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM4);
                //    LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM5);
                //    LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM6);
                //    LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM7);
                //    LIST_PB_CAM_CONSTAT.Add(PB_CONSTAT_CAM8);

                //    LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM4);
                //    LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM5);
                //    LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM6);
                //    LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM7);
                //    LIST_PB_CAM_DISCONSTAT.Add(PB_DISCONSTAT_CAM8);

                //    LIST_PB_LIGHT_CONSTAT.Add(PB_CONSTAT_LIGHT2);

                //    LIST_PB_LIGHT_DISCONSTAT.Add(PB_DISCONSTAT_LIGHT2);
                //}
                //else
                //{
                //    Point tempPoint = PB_CONSTAT_CAM1.Location;
                //    PB_CONSTAT_CAM1.Location = PB_CONSTAT_CAM3.Location;
                //    PB_CONSTAT_CAM3.Location = tempPoint;
                //    PB_DISCONSTAT_CAM1.Location = PB_DISCONSTAT_CAM3.Location;
                //    PB_DISCONSTAT_CAM3.Location = tempPoint;
        ...
        private void BTN_MXTEST_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //int[] setValue = new int[1];
                //setValue[0] = iCmd;
                //Main.PLCsocket.WriteDevice_W((iAddr).ToString(), 1, setValue);
            }
            catch
            {
        ...
        private void timerStatus_Tick(object sender, EventArgs e)
        {
            if (!Main.DEFINE.OPEN_F)
            {
                ...
                //{
                //    PB_CONSTAT_PLC.Visible = true;
                //    PB_DISCONSTAT_PLC.Visible = false;
                //}
                //else
                //{
                //    PB_CONSTAT_PLC.Visible = false;
                //    PB_DISCONSTAT_PLC.Visible = true;
                //}
